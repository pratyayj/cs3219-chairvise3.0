    ...
    export default {
        ...
        methods: {
            ...
            fileUploadHandler: function (file) {
                ...
                } else if(file.raw.type === "application/json"){
                    console.log("json type");
                    this.convertJsonToCSV(file);
                } else if(file.raw.type === "text/xml") {

                }
                // var json = JSON.parse(file);
                // JSON.parse(file);
                // console.log("Formated Json file");
                ...
                Papa.parse(file.raw, {
                    ...
                    complete: function (result) {
                        ...
                        if (this.$store.state.dataMapping.data.tableType == "1") {
                            ...
                            console.log("author anonymization");
                            //console.log(res2);
                        }
                        ...
                        // console.log(res2);
                        console.log("submission file processing end");
